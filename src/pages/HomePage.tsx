...
export default function HomePage() {
  useSEO({
    title: 'Middle Frontend & Mobile Developer Portfolio',
    description: 'Portfolio cá nhân của Nguyễn Minh Hiếu - Middle Frontend & Mobile Developer với 4+ năm kinh nghiệm. Chuyên Flutter, React, TypeScript & Zalo Mini App.',
