...
export default function Footer() {
    return (
        <footer className="py-16 md:py-32 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
            <div className="mx-auto max-w-5xl px-6">
                <div
                    aria-label="go home"
                    className="mx-auto block size-fit">
                   <img src="https://static.vecteezy.com/system/resources/previews/023/654/784/non_2x/golden-logo-template-free-png.png" alt="" className="w-32" />
                </div>
